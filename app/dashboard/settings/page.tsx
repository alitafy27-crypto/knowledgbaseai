...
export default function SettingsPage() {
  ...
  const [fullName, setFullName] = useState("your saas User");
...
function NotificationsSettings() {
  ...
  return (
    <SettingsPanel
      title="Notifications"
      description="Control how your saas keeps you informed."
    >
      <ToggleRow
...
function BillingSettings() {
  return (
    <SettingsPanel
      ...
      description="Manage your your saas plan and payments."
    >
